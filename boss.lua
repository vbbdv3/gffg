...
local mod = main:Button("Criminal Village", function()
local args = {
    [1] = "Teleport",
    [2] = "Spawn",
    [3] = "Criminal Village"
...
game:GetService("ReplicatedStorage").Bridge:FireServer(unpack(args))
wait(1)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-4253.994140625, 20.500877380371094, -4800.7470703125)
  end)

local mod = main:Button("AUTO", function()
while true do wait()
local args = {
    [1] = "Teleport",
    [2] = "Spawn",
